...
#ifndef ________________________________
...
class CreateOwnerDrawButton
	...
	static void DrawButtons(const DRAWITEMSTRUCT *lpDrawItem,HBITMAP g_load,KDib & bmp)
      ...
      ::StretchBlt(
         lpDrawItem->hDC,
         0,0, lpDrawItem->rcItem.right - lpDrawItem->rcItem.left, 
		 lpDrawItem->rcItem.bottom - lpDrawItem->rcItem.top,
         hCDC,
         0,0, bmp.SizeBitmap(hCaptureBitmapp).cx,
		 bmp.SizeBitmap(hCaptureBitmapp).cy,
         SRCCOPY
      );
